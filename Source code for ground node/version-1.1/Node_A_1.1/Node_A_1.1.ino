...
// dummy coordinate (a few hundred meters apart is enough) so the dashboar___d
...
#define NODE_LAT        26.6131     // dummy latitude  (this example: near Delhi)
#define NODE_LON        71.2040     // dummy longitude
